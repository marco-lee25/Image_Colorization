...
from .GAN import build_backbone_unet, pretrain_generator, MainModel
import torch
...
class model_trainer():
    def __init__(self, train_loader, ic, oc, config, display=100):
        ...
        self.generator = pretrain_generator.load_state_dict(torch.load("res18-unet.pt", map_location=device))
